...
<div id="wrapper" class="container-fluid">
	...
	<div id="content-wrapper" class="row-fluid">
    	...
    	<div id="content" class="span12">
    		...
    		<ul class="breadcrumb">
			  ...
			  <li><a href="#">PREP School</a> <span class="divider">/</span></li>
			  <li><a href="#"><?php echo $strReportTitle; ?></a> <span class="divider">/</span></li>
			  <li class="active"><?php if ($_REQUEST['frm_report_by'] == 'supplier') { echo "By Supplier"; } elseif ($_REQUEST['frm_report_by'] == 'product') { echo "By Product"; } else { echo "By Supplier"; } ?></li>
			</ul>			
			...
			<div id="box" class="span12">
			   	...
			   	<div style="text-align:right;">
					...
					&nbsp;&nbsp;&nbsp;
			   		<a class="btn" href="<?php echo $STR_URL; ?>reports_print.php?action=print&frm_year_month=<?php echo $intYearMonth; ?>&frm_report_by=<?php echo urlencode($_REQUEST['frm_report_by']); ?>&report=<?php echo basename($_SERVER['PHP_SELF']); ?>" target="_blank"><img src="<?php echo $STR_URL; ?>img/print_icon.png" /> Print</a>
					&nbsp;&nbsp;&nbsp;
					<a class="btn ajax callbacks cboxElement" href="<?php echo $STR_URL; ?>reports_email.php?action=email&pop=yes&frm_year_month=<?php echo $intYearMonth; ?>&frm_report_by=<?php echo urlencode($_REQUEST['frm_report_by']); ?>&report=<?php echo basename($_SERVER['PHP_SELF']); ?>" title="Send Report to Email"><img src="<?php echo $STR_URL; ?>img/email_icon.png" /> Email</a>
				</div>
   ...
   <script>
   		$(document).ready(function() {
   			$('#frm_report_by').change(function() {
   				window.location = '?frm_report_by=' + $('#frm_report_by option:selected').val() + '&frm_year_month=' + $('#frm_year_month option:selected').val();
   			});
