	...
	<div id="content-wrapper" class="row-fluid">
    	...
    	<div id="content" class="span12">
    		...
    		<ul class="breadcrumb">
			  ...
			  <li class="active"><?php if ($_REQUEST['month'] && $_REQUEST['year']) { echo $html->getMonthName(intval($_REQUEST['month'])) . " " . intval($_REQUEST['year']); } else { echo date('F Y'); } ?></li>
			</ul>
			...
			<div id="box" class="span12">
				...
				<?php if ($_REQUEST['month'] && $_REQUEST['year']) { $intMonth = intval($_REQUEST['month']); $intYear = intval($_REQUEST['year']); } else { $intMonth = date('n'); $intYear = date('Y'); } ?>
				<?php $report->showReportGeneralMonthly($intMonth, $intYear); ?>			   	
