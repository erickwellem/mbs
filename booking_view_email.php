                        ...
                        <div class="tab-content">
                          ...
                          <div class="tab-pane" id="preview-sendtoemail">
                            ...
                            <div>
								...
								<?php echo file_get_contents($STR_URL . 'booking_view_print.php?action=print&for_email=yes&pop=yes&print=false&booking_id=' . $_REQUEST['booking_id']);?>
                            </div>
                          </div>
                        </div>
...
<script>
	$(document).ready(function () {
		$(".btn-submit").click(function () {
			...
			var dataString = "action=" + action + "&booking_id=" + booking_id + "&frm_email_to=" + frm_email_to + "&frm_message=" + frm_message + "&frm_send_copy=" + frm_send_copy;
