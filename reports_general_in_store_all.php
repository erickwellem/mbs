	...
	<div id="content-wrapper" class="row-fluid">
    	...
    	<div id="content" class="span12">
    		...
    		<ul class="breadcrumb">
			  ...
			  <li class="active">All Stores <?php echo $strReportTitle; ?></li>			  
			</ul>			
			...
			<div id="box" class="span12">
			   	...
			   	<div style="text-align:right;">
					...
					&nbsp;&nbsp;&nbsp;
			   		<a class="btn" href="<?php echo $STR_URL; ?>reports_print.php?action=print&frm_year_month=<?php echo $intYearMonth; ?>&report=<?php echo basename($_SERVER['PHP_SELF']); ?>" target="_blank"><img src="<?php echo $STR_URL; ?>img/print_icon.png" /> Print</a>
					&nbsp;&nbsp;&nbsp;
					<a class="btn ajax callbacks cboxElement" href="<?php echo $STR_URL; ?>reports_email.php?action=email&pop=yes&frm_year_month=<?php echo $intYearMonth; ?>&report=<?php echo basename($_SERVER['PHP_SELF']); ?>" title="Send Report to Email"><img src="<?php echo $STR_URL; ?>img/email_icon.png" /> Email</a>
				</div>
