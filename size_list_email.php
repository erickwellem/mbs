                        ...
                        <div class="tab-content">
                          ...
                          <div class="tab-pane" id="preview-sendtoemail">
                            ...
                            <div>
								...
								<?php echo file_get_contents($STR_URL . 'size_list_print.php?action=print&print=false&pop=yes');?>
                            </div>
                          </div>
                        </div>
...
<script>
	$(document).ready(function () {
		$(".btn-submit").click(function () {
			...
			var dataString = "action=" + action + "&frm_email_to=" + frm_email_to + "&frm_message=" + frm_message + "&frm_send_copy=" + frm_send_copy;
