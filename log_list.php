...
<head>
<title><?php echo stripslashes($arrSiteConfig['site_name']); ?> &raquo; Logs List</title> 
	...
	<div id="content-wrapper" class="row-fluid">
    	...
    	<div id="content" class="span12">
    		...
    		<ul class="breadcrumb">
			  ...
			  <li><a href="log_list.php">System Log</a> <span class="divider">/</span></li>			  
			  <li class="active">Logs List</li>
			</ul>
