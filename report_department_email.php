                          ...
                          <div class="tab-pane" id="preview-sendtoemail">
                            ...
                            <div>
                            	...
                            	<?php 
									...
									$intYear = $_GET['year']; 
								?>
								<input type="hidden" id="month" name="month" value="<?php echo $intMonth ?>" />
								<input type="hidden" id="year" name="year" value="<?php echo $intYear ?>" />
								<?php echo file_get_contents($STR_URL . 'report_department_print.php?action=print&print=false&pop=yes&month='.$intMonth.'&year='.$intYear);?>
                            </div>
                          </div>
                        </div>
...
<script>
	$(document).ready(function () {
		$(".btn-submit").click(function () {
			...
			var dataString = "action=" + action + "&frm_email_to=" + frm_email_to + "&frm_message=" + frm_message + "&frm_send_copy=" + frm_send_copy + "&month=" + month + "&year=" + year;

			var request = $.ajax({							    
								url: "ajax/department_email.php",
								type: "post", 
								data: dataString,
