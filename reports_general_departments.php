    	...
    	<div id="content" class="span12">
			...
			<div id="box" class="span12">
			   	...
			   	<div style="text-align:right;">
					...
					&nbsp;&nbsp;&nbsp;
					<a class="btn ajax callbacks cboxElement" href="report_department_email.php?action=email&pop=yes&month=<?php echo $intMonth; ?>&year=<?php echo $intYear; ?>" title="Send Report to Email"><img src="<?php echo $STR_URL; ?>img/email_icon.png" /> Email</a>
				</div>
